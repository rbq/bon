...
- `.homebrew/bon.rb.erb` is the authoritative Homebrew formula template; the reusable Homebrew tap workflow renders it and updates `rbq/homebrew-tap` with `HOMEBREW_TAP_TOKEN`.
