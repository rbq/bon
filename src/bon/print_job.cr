...
module Bon
  module PrintJob
    ...
    def self.run(files : Array(String), printer : String, config : Config, no_crop : Bool = false, extra_options : Hash(String, String) = Hash(String, String).new, output_io : IO = STDOUT, error_io : IO = STDERR, source_resolver : SourceResolver? = nil) : Nil
